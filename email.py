...
# Khởi tạo Tokenizer trước khi áp dụng SMOTE
# Tuy nhiên, SMOTE yêu cầu dữ liệu dạng số, nên trước tiên cần chuyển văn bản thành vector
# Đây là lý do chúng ta sẽ thực hiện chia train/test sau khi vector hóa
